...
public static class SignalEffectExtensions
{
    ...
    public static SignalEffect EffectOnce<TAnchor, TState>(
        this TAnchor anchor,
        TState state,
        Func<TState, ValueTask> func,
        SignalEffectOptions? effectOptions = null,
        ...
        where TAnchor: class
    {
        ...
        return Signals.RunOnce(state, func, group, effectOptions, name, stopToken, retryDelay, errorHandler, cm, lineNumber, cexp);
    }
    
    public static SignalEffect EffectOnce<TAnchor>(
        this TAnchor anchor,
        Func<ValueTask> func,
        SignalEffectOptions? effectOptions = null,
        string? name = null,
        ...
        where TAnchor: class
    {
        ...
        return Signals.RunOnce(func, group, effectOptions, name, stopToken, retryDelay, errorHandler, cm, lineNumber, cexp);
    }
